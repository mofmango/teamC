...
<c:set var="pageTitle" value="좋아요한 레시피"/>

<jsp:include page="/WEB-INF/views/includes/header.jsp"/>

<section class="tc-page-section">
    <div class="tc-page-head">
        <h1 style="font-size:26px; color:white;">좋아요한 레시피</h1>
        <p style="color:#9ca3af;">내가 좋아요를 누른 레시피 목록입니다.</p>
    </div>
                ...
                <tr>
                    ...
                    <td style="text-align:left; padding-left:20px;">
                        <c:url var="readUrl" value="/recipe/get">
                            ...
                            <c:param name="from" value="mylikes" />
    ...
    <c:if test="${not empty pageMaker}">
        <div class="tc-pagination">
            <c:if test="${pageMaker.prev}">
                <c:url var="prevUrl" value="/member/mylikes">
            ...
            <c:forEach var="num" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                <c:url var="pageUrl" value="/member/mylikes">
            ...
            <c:if test="${pageMaker.next}">
                <c:url var="nextUrl" value="/member/mylikes">
