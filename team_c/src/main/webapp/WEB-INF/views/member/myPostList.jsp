...
<style>
    ...
    .tc-table th { padding: 12px; border-bottom: 1px solid #2b2f37; color: #9ca3af; font-weight: 600; text-align: center; }
    .tc-table td { padding: 16px 12px; border-bottom: 1px solid #2b2f37; vertical-align: middle; text-align: center; }
    ...
    .tc-btn { padding: 8px 16px; border-radius: 8px; border: none; font-weight: 600; cursor: pointer; display: inline-flex; text-decoration: none; font-size: 14px; }
...
<c:set var="pageTitle" value="내가 작성한 레시피"/>

<jsp:include page="/WEB-INF/views/includes/header.jsp"/>

<section class="tc-page-section">
    <div class="tc-page-head">
        <h1 class="tc-page-title" style="font-size:26px; color:white;">내가 작성한 레시피</h1>
        <p class="tc-page-sub" style="color:#9ca3af;">내가 직접 작성한 레시피 목록입니다.</p>
    </div>
    ...
    <div style="margin-top: 30px; display: flex; justify-content: space-between;">
        <a href="/recipe/register" class="tc-btn tc-btn-primary">새 레시피 등록</a>
        <button class="tc-btn tc-btn-ghost" onclick="location.href='/member/mypage'">마이페이지로</button>
    </div>
</section>
