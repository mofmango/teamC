...
<main class="tc-container">
    ...
    <!-- 내 냉장고 재료 기반 추천 (3개, 릴스 비슷한 가로 캐러셀) -->
    <section class="tc-section">
        ...
        <c:choose>
            ...
            <c:when test="${empty recommendList}">
                <div class="tc-empty tc-empty-dark">추천 레시피가 아직 없어요.</div>
            </c:when>
                    ...
                    <ul class="tc-free-list">
                        <c:forEach items="${recentFreeList}" var="f">
                            <li class="tc-free-item">
                                ...
                                <!-- 작성자 + 날짜 -->
                                <span class="tc-free-meta" style="margin-left:6px; font-size:12px; opacity:.8;">
...
document.querySelectorAll('.tc-carousel').forEach(function(c){
  ...
  const scrollAmount = 260; // 카드폭+gap 정도
